...
function(e) {
    ...
    j.prototype.setColsWidth = function() {
        ...
        e.eachCols(function(i, a) {
            ...
            a.colspan > 1 || (0 === a.width ? e.getCssRule(t.index + "-" + a.key,
            function(e) {
    ...
    j.prototype.pullData = function(e) {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            /**
             * 开始
             * 添加全局遮罩层,列表加载、查询，调用reder/reload之前
             * date: 2020-03-16
             * auther: lipengpeng
             * */
            ...
            t.ajax({
                ...
                success: function(t) {
                    ...
                    /**
                     * 开始
                     * 关闭全局遮罩层,列表加载、查询，调用reder/reload加载数据完成后
                     * date: 2020-03-16
                     * auther: lipengpeng
                     * */
                    layer.close(indexMask);    //返回数据关闭loading
                    /**
                     * 结束
                     * 关闭全局遮罩层,列表加载、查询，调用reder/reload加载数据完成后
                     * date: 2020-03-16
